...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if                            message.startswith("Summon") or         message.startswith("Summom") or         message.startswith("!summom") or        message.startswith("/summom") or    message.startswith("/s") or  message.startswith("/S")  message.startswith("/summon") or  message.startswith("!summon"):
          if user.username == "FallonXOXO" or user.username == "Its.Melly.Moo.XoXo" or user.username == "iced_yu" or user.username == "sh1n1gam1699" or user.username == "Abbie_38" or user.username == "hidinurbasement" or  user.username == "GothicGirlFae" or user.username == "RayMG":
           target_username = message.split("@")[-1].strip()
